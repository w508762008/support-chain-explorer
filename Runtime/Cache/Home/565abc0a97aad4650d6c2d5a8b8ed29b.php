	...
	<div id="account">
		<div class="card key-value-box mb-3">
			<div class="card-body">
				...
				<div class="container">
					<div class="row"><div class="col-sm-3">ID: </div><div class="col-sm-9"><?php echo ($data["block_id"]); ?></div></div>
					<div class="row"><div class="col-sm-3">Height: </div> <div class="col-sm-9"><?php echo ($data["block_num"]); ?></div></div>
					<div class="row"><div class="col-sm-3">Parent ID: </div> <div class="col-sm-9"><a href="<?php echo U('index/block',array('data'=>$data['prev_block_id']));?>"><?php echo ($data["prev_block_id"]); ?></a></div></div>
					<div class="row"><div class="col-sm-3">Timestamp: </div> <div class="col-sm-9"><?php echo ($data["timestamps"]); ?> </div></div>
					<div class="row"><div class="col-sm-3">Builder: </div> <div class="col-sm-9"><a href="<?php echo U('index/address',array('name'=>$data['builder_account_name']));?>"><?php echo ($data["builder_account_name"]); ?></a></div></div>
					<div class="row"><div class="col-sm-3">Transaction Merkle Root: </div> <div class="col-sm-9"><?php echo ($data["transaction_merkle_root"]); ?></div></div>
				</div>
			</div>
		</div>
