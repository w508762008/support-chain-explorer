...
#page{width:100%;margin-bottom:18px;text-align:center;}
#page span{width: 20px;display: inline-table;line-height: 20px;text-align: center;background-color:#17a2b8;color:#fff;border-radius:3px;}
#page a{width: 20px;display: inline-table;line-height: 20px;text-align: center;color:#333;text-decoration:none;}
...
$(function(){
	$("#nav button").click(function(){
		...
		if(type == 'true'){
			$("#nav_collapse").slideUp(1000);$(this).attr('atia-expanded','false');
		}else{
			$("#nav_collapse").slideDown(1000);$(this).attr('atia-expanded','true');
		}
	});
		...
		<?php if(($type) == "Blocks"): ?><div class="card-body">
				...
				<tbody role="rowgroup" class=""><!---->
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="">
						<td aria-colindex="1" data-label="ID" role="cell" class=""><div><a href="<?php echo U('index/block',array('data'=>$vo['block_id']));?>" class="address-tag"><?php echo ($vo["block_id"]); ?></a></div></td>
						<td aria-colindex="2" data-label="Height" role="cell" class=""><div><a href="<?php echo U('index/block',array('data'=>$vo['block_num']));?>"><?php echo ($vo["block_num"]); ?></a></div></td>
			...
			<?php if(($type) == "Messages"): ?><div class="card-body">
				...
				<tbody role="rowgroup" class=""><!---->
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="">
						...
						<td aria-colindex="2" data-label="Transaction ID" role="cell" class=""><div><a class="address-tag" href="<?php echo U('index/paylist',array('transaction'=>$vo['transaction_id']));?>"><?php echo ($vo["transaction_id"]); ?></a></div></td>
			...
			<?php if(($type) == "Transactions"): ?><div class="card-body">
				...
				<table id="__BVID__17" role="table" aria-busy="false" aria-colcount="8" aria-rowcount="15" class="table b-table table-hover b-table-stacked-sm"><!----><!---->
					...
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="">
							...
							<td aria-colindex="3" data-label="Block id" role="cell" class=""><div><a href="<?php echo U('index/block',array('data'=>$vo['block_id']));?>" target="_self" class="address-tag"><?php echo ($vo["block_id"]); ?></a></div></td>
				...
				<table id="__BVID__17" role="table" aria-busy="false" aria-colcount="8" aria-rowcount="15" class="table b-table table-hover b-table-stacked-sm"><!----><!---->
					<thead class="">
						<tr>
							...
							<!-- <th aria-colindex="2" class="">xmx_token</th> -->
							<!-- <th aria-colindex="3" class="">staked_token</th> -->
							<!-- <th aria-colindex="4" class="">unstaking_token</th> -->
							<th aria-colindex="5" class="">Created Time</th>							
						</tr>
					</thead><!---->
					<tbody role="rowgroup" class=""><!---->
					<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr role="row" class="">
							<td aria-colindex="1" data-label="name" role="cell" class=""><div><a href="javascript:void(0);" target="_self" class="address-tag"><?php echo ($vo["name"]); ?></a></div></td>
							<!-- <td aria-colindex="2" data-label="xmx_token" role="cell" class=""><div><font class="text-success"><?php echo ($vo["xmx_token"]); ?></font></div></td> -->
							<!-- <td aria-colindex="3" data-label="staked_token" role="cell" class=""><div><a href="javascript:void(0);" target="_self" class="address-tag"><?php echo ($vo["staked_token"]); ?></a></div></td> -->
							<!-- <td aria-colindex="4" data-label="unstaking_token" role="cell" class=""><div><?php echo ($vo["unstaking_token"]); ?></div></td> -->
							<td aria-colindex="5" data-label="createdTime" role="cell" class=""><div><?php echo ($vo["createdTimes"]); ?></div></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; endif; ?>
					</tbody>
				</table>
